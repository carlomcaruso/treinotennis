// Gerado automaticamente de 'Periodização Carlo - Tênis - 2026.xlsx' em 2026-08-19
...
"N/A",
"ACADEMIA + CORRIDA",
"TREINO QUADRA + BATE BOLA",
"TREINO AMISTOSO (GUSTAVO)"
],
"ALMOÇO": [
"N/A",
"N/A",
...
"objetivos": {
"JOGOS": [
"INTENSIDADE (LIKE PRO), ENTRANDO NO GOLPE",
"JOGAR MAIS ESTRATEGICAMENTE",
"MELHORAR E GANHAR SEGURANÇA COM SAQUE",
"JOGAR PESO DO CORPO NO BACKHAND"
],
"QUADRA": [
"INTENSIDADE E MOVIMENTAÇÃO LATERAL",
"SPRINT E RESISTÊNCIA"
],
"TREINO PRÁTICO": [
"FORÇA NO BACKHAND",
"MOVIMENTAÇÃO LATERAL E HORIZONTAL",
"CONSISTÊNCIA",
"EFEITO ESTILINGUE NOS GOLPES",
"JOGAR BEM AGACHADO"
]
}
};
...
const FASES = {
"PREPARAÇÃO": "Aeróbico 2-3x/sem (30-60 min) a 70-85% do BPM máx. Força: 15-18 reps, 2-3x/sem. Agilidade e técnico.",
"PRÉ COMPETIÇÃO": "Treino específico. Drills e intervalados com descanso similar ao do tênis. Velocidade, explosão, sprint e pliometria. Força 2-4 sets de 8-10 reps. Aeróbico 20-40 min, 2-3x/sem.",
"COMPETIÇÃO": "Manter performance. Alta intensidade, volume menor para evitar fadiga. Competições e partidas mais difíceis.",
"ACTIVE REST": "Descanso do tênis. Outras atividades de baixa intensidade."
};
